  ...
  \begin{figure}[H]
    \begin{minipage}{0.2\textwidth}
      ...
      \begin{minipage}{0.8\textwidth}
          {\bf rabbit, inc.} \hfill  Head of Applied AI \hspace{0.5cm} {2024 --- Present} \\ \\
          \textit{Joshua leads a team of Applied AIML engineers, working with conversational AI models (LLMs, speech-to-text, text-to-speech) as well as large multimodal models (vision and text). Joshua coordinates between various C-level stakeholders from product, research, and engineering teams.} \\ \\
