...
%
% Important note:
% This template requires the cv.cls file to be in the same directory as this
% cv.tex file. The cv.cls file provides the resume style used for structuring the
% document.
%
% Compile with xelatex or pdflatex
%
% usage: $ pdflatex cv.tex
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
